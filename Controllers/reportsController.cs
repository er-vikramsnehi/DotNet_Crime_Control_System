...
namespace cmspro.Controllers
{
    public class reportsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "fir_id,fir_title,reporter_name,reporter_mobile,reporter_email,report_for,report_summary,report_image,report_processing,report_city,report_state,report_address,police_id")] report report)
        {
