...
namespace cmspro.Areas.Manager.Controllers
{
    public class policeController : Controller
    {
        ...
        // GET: Manager/police/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Manager/police/Create
