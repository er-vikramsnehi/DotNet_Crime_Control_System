...
namespace cmspro.Areas.Manager.Controllers
{
    public class armiesController : Controller
    {
        ...
        // GET: Manager/armies/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Manager/armies/Create
